/** \file msg_action.h
 *
 * $Id: msg_connect.h,v 1.1 2002/03/07 11:09:27 portier Exp $
 */
 ...
 * MA 02111-1307, USA.
 */
#ifndef NL_MSG_CONNECT_H
#define NL_MSG_CONNECT_H
#include "nel/ai/agent/agent_local_mailer.h"
#include "nel/ai/agent/message_script.h"

namespace NLAIAGENT
{
	class CConnectObjectValueMsg : public CMessageScript 
	{
	public:
		static const NLAIC::CIdentType IdConnectObjectValueMsg;
	public:
		...
		{
			return new CConnectObjectValueMsg();
		}
