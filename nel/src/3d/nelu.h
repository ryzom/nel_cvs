 ...
 * <File description>
 *
 * $Id: nelu.h,v 1.2 2001/07/18 13:42:34 corvazier Exp $
 */
...
public:
	 ...
	 */
	static void		initDriver(uint w, uint h, uint bpp=32, bool windowed=true, void *systemWindow=NULL) throw(EDru);
...
public:
	 ...
	 * - initEventServer();
	 */
	static void		init(uint w, uint h, CViewport viewport=CViewport(), uint bpp=32, bool windowed=true, void *systemWindow=NULL) throw(EDru);
