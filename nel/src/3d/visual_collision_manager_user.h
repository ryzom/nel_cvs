 ...
 *
 * $Id: visual_collision_manager_user.h,v 1.6 2004/03/23 15:38:43 berenguier Exp $
 */
...
public:
	...
	virtual uint					addMeshInstanceCollision(const UVisualCollisionMesh &mesh, const NLMISC::CMatrix &instanceMatrix);
