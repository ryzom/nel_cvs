...
# ADD LINK32 nlsound_lowlevel_r.lib nlmisc_r.lib eax.lib eaxguid.lib user32.lib gdi32.lib advapi32.lib dsound.lib shell32.lib /nologo /dll /pdb:none /machine:I386 /out:"../../../../lib/nel_drv_dsound_win_r.dll"
...
# PROP Ignore_Export_Lib 0
# PROP Target_Dir ""
# ADD CPP /nologo /MD /W3 /GR /GX /Zi /O2 /D "NL_RELEASE_DEBUG" /D "_WINDOWS" /D "_USRDLL" /D "DRIVER_DSOUND_EXPORTS" /D "LIBXML_STATIC" /D "WIN32" /D "NDEBUG" /D "_MBCS" /FD /c
# SUBTRACT CPP /Fr /YX /Yc /Yu
# ADD MTL /nologo /D "NDEBUG" /mktyplib203 /win32
# ADD BASE RSC /l 0x40c
# ADD RSC /l 0x40c /d "NDEBUG"
