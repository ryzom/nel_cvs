...
// Export callback
// ---------------------------------------------------------------------------
// The user of CExport can be informed of what's happen in the process with this class and
// can cancel the process by returning true in the isCanceled method.
class IExportCB
{
public:
