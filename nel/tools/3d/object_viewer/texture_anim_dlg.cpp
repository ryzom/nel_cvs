// texture_anim_dlg.cpp : implementation file
//
...
CTextureAnimDlg::CTextureAnimDlg(NL3D::CPSTexturedParticle *p) : _EditedParticle(p)
			, _TextureChooser(NULL), _TextureIndexDialog(NULL)
{	
	nlassert(p) ;
