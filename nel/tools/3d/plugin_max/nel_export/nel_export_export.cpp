 ...
 * <File description>
 *
 * $Id: nel_export_export.cpp,v 1.5 2001/07/11 16:11:29 corvazier Exp $
 */
...
bool CNelExport::exportMesh (const char *sPath, INode& node, Interface& ip, TimeValue time, CExportNelOptions &opt)
{
	...
	if (os.obj)
	{
		...
		IShape*	pShape=CExportNel::buildShape (node, ip, time, skeletonShape, false, opt, false);
...
bool CNelExport::exportSkeleton	(const char *sPath, INode* pNode, Interface& ip, TimeValue time)
{
	...
	CExportNel::buildSkeletonShape (*skeletonShape, *pNode, NULL, time);
