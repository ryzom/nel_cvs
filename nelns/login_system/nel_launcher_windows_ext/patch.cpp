/** \file patch.cpp
 *
 * $Id: patch.cpp,v 1.1.2.3 2003/05/28 17:13:20 lecroart Exp $
 */
...
// The file is auto generated by the nel launcher (and deleted) when the .cfg or .exe has been changed
static const string UpdateNelLauncherBatchFilename = "update_nel_launcher.bat";

// This file must be in the patch server, will be execute after killing nel_launcher
static const string RelaunchNelLauncherBatchFilename = "relaunch_nel_launcher.bat";

// This file must be in the patch server, will be execute after the patching and waiting the end of the .bat to continue to execute the launcher
static const string FinalizeNelLauncherBatchFilename = "finalize_patch.bat";
...
private:
	...
	void run ()
	{
		try
		{
			...
			if (patchBat)
			{
				setState (true, "Launching %s", RelaunchNelLauncherBatchFilename.c_str());
			...
			if (executeFinalizeBat)
			{
				...
				setState (true, "Launching %s", FinalizeNelLauncherBatchFilename.c_str());
				system(FinalizeNelLauncherBatchFilename.c_str());
			}
