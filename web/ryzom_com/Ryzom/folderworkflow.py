...
# Date: 2006/02/23 18:03:55.161 GMT+1
#
...
def setupFolder_workflow(wf):
    ...
    sdef.setPermission('Modify portal content', 0, ['Manager', 'Member', 'Owner'])
    ...
    sdef.setPermission('Access contents information', 0, ['Authenticated', 'Editor', 'Manager', 'Member', 'Owner', 'Player', 'Reviewer'])
    sdef.setPermission('Modify portal content', 0, ['Editor', 'Manager', 'Owner'])
    sdef.setPermission('View', 0, ['Authenticated', 'Editor', 'Manager', 'Member', 'Owner', 'Player', 'Reviewer'])
    sdef.setPermission('List folder contents', 0, ['Editor', 'Manager', 'Owner'])
