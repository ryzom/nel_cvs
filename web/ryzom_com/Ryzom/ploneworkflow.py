...
# Date: 2006/04/21 14:06:02.992 GMT+2
#
...
def setupPlone_workflow(wf):
    ...
    for s in ['private', 'visible', 'draft', 'pending', 'published', 'public', 'announced']:
        wf.states.addState(s)
    for t in ['hide', 'publish', 'draft', 'submit', 'reject', 'retract', 'announce', 'make_public']:
    ...
    sdef.setProperties(title="""Public""",
                       transitions=('announce', 'hide', 'retract'))
    sdef.setPermission('Access contents information', 0, ['Animator', 'Anonymous', 'Authenticated', 'Editor', 'Guest', 'Manager', 'Member', 'Owner', 'Player', 'Reviewer'])
    sdef.setPermission('Modify portal content', 0, ['Editor', 'Manager', 'Owner'])
    sdef.setPermission('View', 0, ['Animator', 'Anonymous', 'Authenticated', 'Editor', 'Guest', 'Manager', 'Member', 'Owner', 'Player', 'Reviewer'])
    sdef.setPermission('Change portal events', 0, ['Editor', 'Manager', 'Owner'])

    sdef = wf.states['announced']
    sdef.setProperties(title="""Announced""",
                       transitions=('hide', 'retract'))
    sdef.setPermission('Access contents information', 0, ['Editor', 'Manager', 'Member', 'Owner', 'Player', 'Reviewer'])
    sdef.setPermission('Modify portal content', 0, ['Editor', 'Manager', 'Owner'])
    sdef.setPermission('View', 0, ['Editor', 'Manager', 'Member', 'Owner', 'Player', 'Reviewer'])
    sdef.setPermission('Change portal events', 0, ['Editor', 'Manager', 'Owner'])
    ...
    tdef = wf.transitions['announce']
    tdef.setProperties(title="""Announce on Ring-dev""",
                       new_state_id="""announced""",
                       trigger_type=1,
                       script_name="""email_notifier""",
                       after_script_name="""""",
                       actbox_name="""Announce on Ring-dev""",
                       actbox_url="""""",
                       actbox_category="""workflow""",
