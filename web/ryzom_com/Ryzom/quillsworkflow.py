...
# Date: 2006/02/23 18:06:18.173 GMT+1
#
...
def setupQuills_workflow(wf):
    ...
    for t in ['make_public', 'hide', 'publish', 'draft', 'submit', 'reject', 'retract', 'make_draft', 'announced', 'publish_in_place']:
    ...
    sdef.setProperties(title="""""",
                       transitions=('announced', 'hide', 'make_draft', 'reject', 'retract'))
    sdef.setPermission('Modify portal content', 0, ['Manager', 'Owner'])
    ...
    sdef.setProperties(title="""""",
                       transitions=('announced', 'hide', 'retract'))
    sdef.setPermission('Modify portal content', 0, ['Manager', 'Owner'])
    ...
    sdef.setPermission('Modify portal content', 0, ['Manager', 'Owner'])
    sdef.setPermission('View', 0, ['Manager', 'Member', 'Owner', 'Reviewer'])
    sdef.setPermission('Access contents information', 0, ['Manager', 'Member', 'Owner', 'Reviewer'])
    sdef.setPermission('Change portal events', 0, ['Manager', 'Owner'])
    ...
    tdef = wf.transitions['announced']
    tdef.setProperties(title="""annouced on ryzom-dev""",
                       new_state_id="""announced""",
                       trigger_type=1,
                       script_name="""""",
                       after_script_name="""""",
                       actbox_name="""Announce on ryzom-dev""",
                       actbox_url="""""",
                       actbox_category="""workflow""",
